...
var Neo4j = function (settings, dataSource) {
    ...
    Connector.call(this, "neo4j-relations", settings);
...
Neo4j.prototype.create = function (model, data, options, callback) {
    ...
    self.db.cypher({
        "query": "MATCH (a:"+sourceModelName+" {id: '" + data.sourceId + "'}),(b:"+targetModelName+" {id: '" + data.targetId + "'}) MERGE (a)-[r:"+self.label(model)+" {properties}]->(b) RETURN r",
        "params": {
            "properties": data
        }
    }, function (error, response) {
